...
echo "Clone content"
git clone ${repositoryUrl} "${tmpDir}/proofdict.github.io"
# delete all files
echo "Remove files"
remove_files_in_dir "${tmpDir}/proofdict.github.io"
# execute command
echo "Update content"
execute "$commands"
echo "Copy files"
cp -Rf "${distDir}/"* "${tmpDir}/proofdict.github.io/"
echo "Commit and push"
cd "${tmpDir}/proofdict.github.io/"
